  ...
  return (
    ...
    >
      ...
      <div className='flex-auto flex flex-col items-end py-4 pr-4 stroke-redorange'>
        <svg xmlns="http://www.w3.org/2000/svg" onClick={handleDelete} className='hover:cursor-pointer' width="20" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
