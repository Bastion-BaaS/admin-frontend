  ...
  return (
    ...
    >
      <div className='flex-none flex flex-row items-center py-4 px-4 w-1/2'>
        ...
        <p className={'flex-auto font-semibold text-md ml-1 ' + (active ? 'text-redorange' : 'text-bdazzledblue')}>{name}</p>
      </div>
      <div className='flex-auto flex flex-col items-end py-4 pr-4 stroke-redorange'>
        <svg onClick={handleDelete} className='hover:cursor-pointer' xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
